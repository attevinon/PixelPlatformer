...
namespace PixelCrew.UI.MainMenu
{
    ...
    public class MainMenuWindow : MonoBehaviour
    {
        ...
        private AdditionalWindow _settings;
        ...
        {
            if(_moveAnimation != null && _moveAnimation.IsPlaying()) return;
            MoveX(false);
            if (_settings == null)
            {
                ...
                _settings = settingsWindow.GetComponent<AdditionalWindow>();
